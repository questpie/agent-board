...
const SKILL_DOCS: ReadonlyArray<{ source: string; text: string }> = [
	...
	{ source: "agent-board-safe-workflow/SKILL.md", text: safeWorkflowSkillReadme },
	{ source: "agent-board-safe-workflow/AGENTS.md", text: safeWorkflowSkillAgents },
	...
	{ source: "agent-board-design-qa/SKILL.md", text: designQaSkillReadme },
	{ source: "agent-board-design-qa/AGENTS.md", text: designQaSkillAgents },
